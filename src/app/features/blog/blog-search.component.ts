  ...
  template: `
    <div class="min-h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
      ...
      <header class="space-y-6 max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-5xl font-['Space_Grotesk'] font-bold text-white tracking-tight">Search & Knowledge Hub</h1>
      ...
      <section class="space-y-8">
        <div class="flex items-center justify-between border-b border-[#242428] pb-4">
          <h2 class="text-2xl sm:text-3xl font-['Space_Grotesk'] font-bold text-white">Engineering Cheat Sheets & Architecture Notes</h2>
          ...
          @for (res of filteredResources(); track res.id) {
            <div class="p-6 rounded-2xl bg-[#131316] border border-[#242428] hover:border-[#3B82F6]/50 transition-all duration-300 flex flex-col justify-between space-y-4">
              <div class="space-y-3">
                ...
                <h4 class="text-lg font-bold text-white font-['Space_Grotesk']">{{ res.title }}</h4>
      ...
      <section class="space-y-8">
        <div class="flex items-center justify-between border-b border-[#242428] pb-4">
          <h2 class="text-2xl sm:text-3xl font-['Space_Grotesk'] font-bold text-white">Matching Technical Essays</h2>
